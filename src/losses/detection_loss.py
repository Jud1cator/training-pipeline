...
def loss_fn(
    ...
    Args:
        ...
        cls_targets: ground truth class targets.

        box_targets: ground truth box targets.

        num_positives: num positive ground truth anchors
...
class DetectionLoss(nn.Module):
    ...
    def __init__(
        ...
        self.legacy_focal = legacy_focal
        self.use_jit = jit_loss
