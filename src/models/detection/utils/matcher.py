...
class Match(object):
    ...
    def __init__(self, match_results: torch.Tensor):
        ...
        Raises:
            ValueError: if match_results does not have rank 1 or is not an integer int32 scalar
            tensor
        """
    ...
    def matched_row_indices(self):
        ...
        and self.matched_row_indices() is [7, 3], then we know that column 0 was matched to row 7
        and column 2 was matched to row 3.
    ...
    def gather_based_on_match(self, input_tensor, unmatched_value, ignored_value):
        ...
        input_tensor[match_results[col]].
        For columns that are unmatched, gathered_tensor[col] is set to unmatched_value.
        Finally, for columns that are ignored gathered_tensor[col] is set to ignored_value.
        ...
        Returns:
            gathered_tensor: A tensor containing values gathered from input_tensor.
                The shape of the gathered tensor is
                [match_results.shape[0]] + input_tensor.shape[1:].
        """
